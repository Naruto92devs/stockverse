...
export default function Stockverse_GPT() {
    ...
    return (
        <section className="flex items-start h-[100dvh] overflow-hidden relative scrollbar-hide">
            ...
            {/* Loader start*/}
            <div className={`${loading ? 'visible' : 'hidden'} absolute z-20 top-0 left-0 bottom-0 right-0 bg-primaryText/30 flex items-center justify-center`}>
                <div id="wifi-loader">
            ...
            <div className="relative flex flex-col items-start justify-start gap-y-4 max-w-full flex-grow h-[100%] overflow-y-scroll scrollbar-thin">
                ...
                {/* Chat Navbar start */}
                <div className='sticky z-30 top-0 max-lg:fixed py-3 px-2 bg-background flex items-start justify-end w-full h-max'>
