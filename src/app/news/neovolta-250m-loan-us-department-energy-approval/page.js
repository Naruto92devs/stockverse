...
const PRESSRELEASENEOV = () => {
    ...
    const pressReleaseUrl = `https://stockverse.com/news/neovolta-250m-loan-us-department-energy-approval`; // The current URL
        ...
        <>
          ...
          <div className="w-full h-full mx-auto xl:container lg:px-[15%] max-xl:px-3">
            ...
            <div className="flex flex-col gap-6 py-4 2xl:pb-16 lg:pb-16 pb-8">
                ...
                <p className="text-base text-primaryText font-sansRegular leading-[150%]">{`"We are confident in our application to the DOE," added Johnson, "and believe that we are well positioned to provide technical feasibility, as well as other required due diligence." `} </p>
                <h3 className="text-xl text-primaryText md:text-2xl 2xl:text-3xl font-sansMedium pt-2">NeoVolta</h3>
                ...
                <h4 className="text-xl text-primaryText md:text-2xl 2xl:text-3xl font-sansMedium pt-2">Forward-Looking Statements</h4>
                ...
                <div className="flex flex-col gap-1">
                    <p className="text-base text-primaryText font-sansRegular leading-[150%]">{`SOURCE NeoVolta`}</p>
                </div>
            </div>
            <Disclaimer/>
        </div>
