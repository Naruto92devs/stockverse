...
const PRESSRELEASECVKD = () => {
    ...
    const pressReleaseUrl = `https://stockverse.com/news/cvkd-drug-of-the-year`; // The current URL
        ...
        <>
          ...
          <div className="w-full h-full mx-auto xl:container lg:px-[15%] max-xl:px-3">
            <div className="py-8 gap-y-6">
                <h1 className="text-4xl 2xl:text-5xl font-sansMedium max-sm:text-[1.6rem]  text-left text-primaryText  leading-[140%] 2xl:leading-[140%]">Cadrenal Therapeutics Named Anticoagulation Therapy Company of the Year by Pharma Tech Outlook</h1>
            </div>
            <div className="pt-8 lg:pt-4 flex flex-col sm:flex-row gap-y-6 justify-between items-start sm:items-center border-t border-[#404040]">
                <Link href='/dashboard?view=news' className=" leading-[110%] 2xl:text-xl text-sm font-sansMedium text-[#634FF7]">Nov 19, 2024 by Stockverse</Link>
                <div className="">
            ...
            <div className="flex flex-col gap-6 py-4 2xl:pb-16 lg:pb-16 pb-8">
                ...
                <div className="flex flex-col gap-1">
                    <p className="text-base  text-primaryText leading-[200%] font-sansRegular">Investors:</p>
                    <p className="text-base  text-primaryText leading-[200%] font-sansRegular">Lytham Partners, LLC</p>
                    <p className="text-base  text-primaryText leading-[200%] font-sansRegular">Robert Blum, Managing Partner</p>
                    <p className="text-base  text-primaryText leading-[200%] font-sansRegular">602-889-9700</p>
                    <p className="text-base  text-primaryHeading leading-[200%] font-sansRegular"><Link href='mailto:CVKD@lythampartners.com'>CVKD@lythampartners.com</Link></p>
                </div>

                <div className="flex flex-col gap-1">
                    <p className="text-base leading-[200%] font-sansRegular">View original content to download multimedia:<Link className="text-primaryHeading" href='https://www.prnewswire.com/news-releases/cadrenal-therapeutics-named-anticoagulation-therapy-company-of-the-year-by-pharma-tech-outlook-302309432.html'>https://www.prnewswire.com/news-releases/cadrenal-therapeutics-named-anticoagulation-therapy-company-of-the-year-by-pharma-tech-outlook-302309432.html</Link></p>
                </div>
