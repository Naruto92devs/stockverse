...
const PRESSRELEASECVKD = () => {
    ...
    const pressReleaseUrl = `https://stockverse.com/news/pr2025`; // The current URL
        ...
        <>
          ...
          <div className="w-full h-full mx-auto xl:container lg:px-[15%] max-xl:px-3">
            <div className="py-8 gap-y-6">
                <h1 className="text-4xl 2xl:text-5xl font-sansMedium max-sm:text-[1.6rem]  text-left text-primaryText  leading-[140%] 2xl:leading-[140%]">PONTE VEDRA BIOTECH FIRM OPENS THE NASDAQ</h1>
            </div>
            ...
            <div className="flex flex-col gap-6 py-4 2xl:pb-16 lg:pb-16 pb-8">
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[150%]">Ponte Vedra Beach-based biopharmaceutical company Cadrenal Therapeutics Inc. was among several companies that rung in the bell Monday to open the Nasdaq.</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">The biotech companies rung in the bell as part of the annual J.P. Morgan Healthcare Conference, the first national industry gathering since the killing of UnitedHealthcare CEO Brian Thompson in New York ahead of investor day meetings.</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`The event typically highlights new drugs, deals and investors, but in the wake of the shooting,`}<Link href="https://www.bizjournals.com/sanfrancisco/news/2025/01/13/jpm-security-luigi-mangione-brian-thompson-united.html" className="text-primaryHeading">{`security is a key issue for this year's event.`}</Link></p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`"It’s an honor to represent Jacksonville and Florida as part of the Nasdaq Biotech Index companies to ring the opening bell from San Francisco," Cadrenal CEO & Founder Quang X. Pham told the Business Journal Monday. "This morning is the kickoff of the annual JP Morgan Healthcare Conference Week, our biggest and most important gathering.`}</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`Despite the added security and national discourse, Pham said he plans to highlight the region's success and use the event to promote the local tech and health care scene.`}</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`“As a former Marine Corps officer, I provide my own security by being vigilant about my surroundings all the time,” he added.`}</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`The Cadrenal (Nasdaq: CVKD) recently `}<Link href="https://www.bizjournals.com/jacksonville/news/2024/04/09/cadrenal-therapeutics-receives-fda-approval.html" className="text-primaryHeading">{`Orphan Drug Designation`}</Link> {`for its late-stage novel oral and reversible anticoagulant tecarfarin. The blood thinner designed to prevent heart attacks, strokes and deaths due to blood clots in patients with rare cardiovascular conditions was granted the status by the`} <Link href="https://www.bizjournals.com/jacksonville/organization/us-food-and-drug-administration" className="text-primaryHeading">{`FDA`}</Link>{` for the prevention of thromboembolism and thrombosis in patients with an implanted mechanical circulatory support device. The only LVAD available in the United States is the HeartMate 3, manufactured by Abbott. All patients with LVADs require lifelong anticoagulation to protect against thromboembolic events. Last summer Cadrenal announced that it is in discussion with Abbott about a collaboration in its pivotal study later this year.`}</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`Also, Cadrenal Therapeutics recently announced it raised approximately $9.8 million in recent financing transactions.`}</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`Shares of CVKD were $15.84 as of press time Monday.`}</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`Consider joining our membership too.`}</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`Consider joining our membership too.`}</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`Happy investing,`}</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">{`Mark w/ StockVerse`}</p>
            </div>
            <Disclaimer/>
        </div>
        </>
