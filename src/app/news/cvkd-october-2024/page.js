        ...
        <>
          ...
          <div className="w-full h-full mx-auto xl:container lg:px-[15%] max-xl:px-3">
            ...
            <div className="flex flex-col gap-6 py-4 2xl:pb-16 lg:pb-16 pb-8">
                ...
                <p className="text-base text-primaryText leading-[140%] font-sansRegular">Current Price: $18.7</p>
                <p className="text-base text-primaryText leading-[140%] font-sansRegular">Market Cap: $33.3m as of 9/2/2024</p>
