...
const Cvkd = () => {
    ...
    const pressReleaseUrl = `https://stockverse.com/news/cvkd-october-2024`; // The current URL
        ...
        <>
          ...
          <div className="w-full h-full mx-auto xl:container lg:px-[15%] max-xl:px-3">
            <div className="py-8 gap-y-6">
                <h1 className="text-4xl 2xl:text-5xl font-sansMedium max-sm:text-[1.6rem]  text-left text-primaryText  leading-[140%] 2xl:leading-[140%]">Zacks Research Sets $30 Price Target for <span className="text-buy">CVKD</span>: Best Stock For October 2024</h1>
            </div>
            <div className="pt-8 lg:pt-4 flex flex-col sm:flex-row gap-y-6 justify-between items-start sm:items-center border-t border-[#404040]">
                <Link href='/dashboard?view=news' className=" leading-[110%] 2xl:text-xl text-sm font-sansMedium text-[#634FF7]">Oct 21, 2024 by Stockverse</Link>
                <div className="">
            ...
            <div className="flex flex-col gap-6 py-4 2xl:pb-16 lg:pb-16 pb-8">
                <h2 className="text-xl text-primaryText md:text-2xl 2xl:text-3xl font-sansMedium pt-2">Cadrenal Therapeutics (CVKD) current price $12: New Blood Thinner Ready for Phase 3 Trials</h2>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[150%]">Cadrenal Therapeutics (CVKD) is positioned as a potential top stock for October 2024, with Zacks Research setting a $30 price target, well above its current $12 value. The company is advancing Tecarfarin, an oral blood thinner in Phase 3 trials targeting conditions like strokes, heart attacks, and clotting disorders for patients with LVADs, ESKD, and AFib.</p>
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">With FDA Orphan Drug Designation and Fast Track Status, Tecarfarin may offer market advantages if approved, potentially addressing unmet needs. However, investors should consider risks like competition, clinical trial outcomes, and regulatory challenges. Projected peak sales of $1.5 billion depend on successful market entry and adoption.</p>
                <h3 className="text-xl text-primaryText md:text-2xl 2xl:text-3xl font-sansMedium pt-2">More Information on CVKD</h3>
                
                <p className="text-base 2xl:text-xl text-primaryText leading-[140%] font-sansRegular">Current Price: $18.7</p>
                <p className="text-base 2xl:text-xl text-primaryText leading-[140%] font-sansRegular">Market Cap: $33.3m as of 9/2/2024</p>
                <p className="text-base 2xl:text-xl text-primaryText leading-[140%] font-sansRegular"><Link className="underline" href="https://finance.yahoo.com/news/cvkd-blood-thinner-ready-phase-092200259.html?guccounter=1&guce_referrer=aHR0cHM6Ly9iaWdzdG9ja3MuY29tLw&guce_referrer_sig=AQAAADtZVXvmMGPcEXkG73t9YhCct_4oz0w2laCO7RmuUQbMfQusQVNM-kTmdKaQ3bzKDutSTQQyIdTwpuDvqk4zKmTIthAAhm7AeLKdmhRGdNp8i2TS7rZ8rQ94rRkPQGj6LO1fcmgVuq8g9IYxkfGG0SdlkDKeVP1v09fehK8pCy5q">Recent Press: CVKD: New Blood Thinner Ready for Phase 3; Initiating Coverage of Cadrenal Therapeutics, Inc…</Link></p>
                <p className="text-base 2xl:text-xl text-primaryText leading-[140%] font-sansRegular"><Link className="underline" href="https://finance.yahoo.com/news/cadrenal-therapeutics-announces-upcoming-type-130000800.html">Cadrenal Therapeutics Announces Upcoming Type-B FDA Meeting in September to Discuss Tecarfarin Trial in LVAD Patients</Link></p>
                <Image className="w-[45%] h-[100%] self-center" width={398} height={815} src='/images/cvkd-news.jpeg' alt="iPhone"/>
                <h4 className="text-xl text-primaryText md:text-2xl 2xl:text-3xl font-sansMedium pt-2 text-center">Add <span className="text-buy">CVKD</span> To your watchlist!</h4>
                <div className="w-full h-full flex justify-center gap-x-8">
                    <Image className="w-[12%] h-[100%]" width={125} height={125} src='/images/fedelity.jpeg' alt="iPhone"/>
                    <Image className="w-[12%] h-[100%]" width={125} height={125} src='/images/td.jpeg' alt="iPhone"/>
                    <Image className="w-[12%] h-[100%]" width={125} height={125} src='/images/charles.jpeg' alt="iPhone"/>
                    <Image className="w-[12%] h-[100%]" width={125} height={125} src='/images/article-link.jpeg' alt="iPhone"/>
                </div>
            </div>
            <Disclaimer/>
        </div>
