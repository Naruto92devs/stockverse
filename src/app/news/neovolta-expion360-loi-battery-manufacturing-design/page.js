...
const PRESSRELEASENEOV = () => {
    ...
    const pressReleaseUrl = `https://stockverse.com/news/neovolta-expion360-loi-battery-manufacturing-design`; // The current URL
        ...
        <>
          ...
          <div className="w-full h-full mx-auto xl:container lg:px-[15%] max-xl:px-3">
            <div className="py-8 gap-y-6">
                <h1 className="text-4xl 2xl:text-5xl font-sansMedium max-sm:text-[1.6rem]  text-left text-primaryText  leading-[140%] 2xl:leading-[140%]">NeoVolta and Expion360 Announce LOI to Advance Battery Manufacturing and Product Design</h1>
            </div>
            <div className="pt-8 lg:pt-4 flex flex-col sm:flex-row gap-y-6 justify-between items-start sm:items-center border-t border-[#404040]">
                <Link href='/dashboard?view=news' className=" leading-[110%] 2xl:text-xl text-sm font-sansMedium text-[#634FF7]">Dec 11, 2024 by Stockverse</Link>
                <div className="">
            ...
            <div className="flex flex-col gap-6 py-4 2xl:pb-16 lg:pb-16 pb-8">
                ...
                <h2 className="text-xl text-primaryText md:text-2xl 2xl:text-3xl font-sansMedium pt-2">About NeoVolta</h2>
                <p className="text-base text-primaryText font-sansRegular leading-[140%]">{`NeoVolta is dedicated to providing reliable, sustainable, and high-performance energy storage systems. With a focus on cutting-edge technology and strategic partnerships, NeoVolta is committed to driving progress in renewable energy and enhancing how the world stores and uses power.`} </p>
                <h3 className="text-2xl font-sansMedium text-primaryText leading-[200%]">About Expion360</h3>
                <p className="text-base text-primaryText font-sansRegular leading-[140%]">{`Expion360 is an industry leader in premium lithium iron phosphate (LiFePO4) batteries and accessories for recreational vehicles and marine applications, with residential and industrial applications under development. On December 19, 2023, the Company announced its entrance into the home energy storage market with the introduction of two premium LiFePO4 battery storage systems that enable residential and small business customers to create their own stable micro-energy grid and lessen the impact of increasing power fluctuations and outages.`} </p>
                <p className="text-base text-primaryText font-sansRegular leading-[140%]">The {`Company’s`} lithium-ion batteries feature half the weight of standard lead-acid batteries while delivering three times the power and ten times the number of charging cycles. Expion360 batteries also feature better construction and reliability compared to other lithium-ion batteries on the market due to their superior design and quality materials. Specially reinforced, fiberglass-infused, premium ABS and solid mechanical connections help provide top performance and safety. With Expion360 batteries, adventurers can enjoy the most beautiful and remote places on Earth even longer. The Company is headquartered in Redmond, Oregon. Expion360 lithium-ion batteries are available today through more than 300 dealers, wholesalers, private-label customers, and OEMs across the country. To learn more about the Company, visit <Link href='https://expion360.com'> Expion360.com.</Link></p>
                <h4 className="text-xl text-primaryText md:text-2xl 2xl:text-3xl font-sansMedium pt-2">Forward-Looking Statements and Safe Harbor Notice</h4>
                <p className="text-base text-primaryText font-sansRegular leading-[140%]">{`This press release contains certain forward-looking statements within the meaning of Section 27A of the Securities Act of 1933, as amended, and Section 21E of the Securities Exchange Act of 1934, as amended, which statements are subject to considerable risks and uncertainties. The Company intends such forward-looking statements to be covered by the safe harbor provisions contained in the Private Securities Litigation Reform Act of 1995. All statements other than statements of historical facts included in this press release, including statements about our beliefs and expectations, are "forward-looking statements" and should be evaluated as such. Examples of such forward-looking statements include statements that use forward-looking words such as "projected," "expect," "possibility,” “believe,” “aim,” “goal,” “plan,” and "anticipate," or similar expressions. Forward-looking statements included in this press release include, but are not limited to, statements relating to NeoVolta’s and Expion360’s future development plans, growth prospects, and market opportunity; the contemplated collaboration between the parties, including the development of a manufacturing facility and product designs; NeoVolta’s ability to comply with regulatory requirements and obtain necessary approvals; and the impact of any collaboration between the parties on the energy storage industry. Forward-looking statements are subject to and involve risks, uncertainties, and assumptions that may cause the Company’s actual results, performance or achievements to be materially different from any future results, performance or achievements predicted, assumed or implied by such forward-looking statements.`}</p>

                <div className="flex flex-col gap-1">
                    <p className="text-lg font-sansMedium text-primaryText leading-[200%]">{`NeoVolta Contact:`}</p>
                    <p className="text-base text-primaryText leading-[120%] font-sansRegular">{`Kate Countryman`}</p>
                    <p className="text-base text-primaryText leading-[120%] font-sansRegular">{`858-239-2349`}</p>
                    <p className="text-base text-primaryHeading leading-[120%] font-sansRegular"><Link href='mailto:press@neovolta.com'>press@neovolta.com</Link></p>
                </div>
                <div className="flex flex-col gap-1">
                    <p className="text-lg font-sansMedium text-primaryText leading-[200%]">{`Expion360 Contact:`}</p>
                    <p className="text-base text-primaryText leading-[120%] font-sansRegular">{`Brian Schaffner, CEO`}</p>
                    <p className="text-base text-primaryText leading-[120%] font-sansRegular">{`541-797-6714`}</p>
                    <p className="text-base text-primaryHeading leading-[120%] font-sansRegular"><Link href='https://expion360.com/pages/contact'>Email Contact</Link></p>
                </div>
                <div className="flex flex-col gap-1">
                    <p className="text-lg font-sansMedium text-primaryText leading-[200%]">{`External Investor Relations:`}</p>
                    <p className="text-base text-primaryText leading-[120%] font-sansRegular">{`Chris Tyson, Executive Vice President`}</p>
                    <p className="text-base text-primaryText leading-[120%] font-sansRegular">{`MZ Group - MZ North America`}</p>
                    <p className="text-base text-primaryText leading-[120%] font-sansRegular">{`949-491-8235`}</p>
                    <p className="text-base text-primaryHeading leading-[120%] font-sansRegular"><Link href='mailto:XPON@mzgroup.us'>XPON@mzgroup.us</Link></p>
                    <p className="text-base text-primaryHeading leading-[120%] font-sansRegular"><Link href='https://www.mzgroup.us/'>www.mzgroup.us</Link></p>
                </div>
