...
const PRESSRELEASECVKD = () => {
    ...
    const pressReleaseUrl = `https://stockverse.com/news/cadrenal-therapeutics-jp-morgan-healthcare-conference-2024`; // The current URL
        ...
        <>
          ...
          <div className="w-full h-full mx-auto xl:container lg:px-[15%] max-xl:px-3">
            <div className="py-8 gap-y-6">
                <h1 className="text-4xl 2xl:text-5xl font-sansMedium max-sm:text-[1.6rem]  text-left text-primaryText  leading-[140%] 2xl:leading-[140%]">Cadrenal Therapeutics Gears Up for the 43rd Annual J.P. Morgan Healthcare Conference Week with Event Participation and Investor/Partner Meetings</h1>
            </div>
            <div className="pt-8 lg:pt-4 flex flex-col sm:flex-row gap-y-6 justify-between items-start sm:items-center border-t border-[#404040]">
                <Link href='/dashboard?view=news' className=" leading-[110%] 2xl:text-xl text-sm font-sansMedium text-[#634FF7]">Dec 18, 2024 by Stockverse</Link>
                <div className="">
            ...
            <div className="flex flex-col gap-6 py-4 2xl:pb-16 lg:pb-16 pb-8">
                ...
                <p className="text-base 2xl:text-xl text-primaryText font-sansRegular leading-[140%]">View source version on businesswire.com: 
