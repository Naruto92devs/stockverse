            ...
            <form onSubmit={handleSubscribeEmailPhone} className="w-full flex flex-col md:flex-row gap-4 w-full">
              <div className="xl:w-[35%] w-full">
                <input
                  ...
                  className="font-sansMedium w-full p-4 border-[1.5px] border-[#A5A4A1] rounded-xl placeholder:text-base text-[#A5A4A1] focus:outline-none focus:ring-2 focus:ring-gray-400"
                />
              </div>
              <div className="xl:w-[35%] w-full">
                <PhoneInput
