export async function GET() {
  ...
  const pages = [
    ...
    {slug: "news/caring-brand-lists-on-otcqb", lastmod: new Date().toISOString().split("T")[0], changefreq: "monthly", priority: "0.8"},
    {slug: "albt", lastmod: new Date().toISOString().split("T")[0], changefreq: "daily", priority: "1"},
