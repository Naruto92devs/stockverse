...
export default function LineChart({ticker, fullScreen, selectedInterval}) {
  ...
  useEffect(() => {
    ...
    newAreaSeries.setData(seriesesData[selectedInterval]);
  ...
  useEffect(() => {
    if (lineSeries) {
      ...
      lineSeries.setData(seriesesData[selectedInterval]);
      lineSeries.applyOptions({ color: intervalColors[selectedInterval] });
    }
  }, [selectedInterval]);
