...
const seriesesData = {
  "1D": [
    { time: "2018-10-19", open: 26.1, high: 27, low: 25.5, close: 26.19 },
    { time: "2018-10-22", open: 26, high: 26.2, low: 25.5, close: 25.87 },
    { time: "2018-10-23", open: 25.8, high: 26.1, low: 25.5, close: 25.83 },
  ],
  "5D": [
    { open: 50, high:51, low: 49, close: 50.5, time: 1642427876 },
    { open: 50.5, high: 51.2, low: 50.1, close: 51, time: 1642431476 },
    { open: 51, high:51.5, low: 50.8, close: 51.2, time: 1642435076 },
    { open: 51.2, high: 51.8, low: 51, close: 51.4, time: 1642438676 },
    { open: 51.4, high: 52, low: 51.2, close: 51.8, time: 1642442276 },
    { open: 51.8, high: 52.4, low: 51.6, close: 52.1, time: 1642445876 },
    { open: 52.1, high: 52.6, low: 51.9, close: 52.4, time: 1642449476 },
    { open: 52.4, high: 52.9, low: 52.2, close: 52.7, time: 1642453076 },
    { open: 52.7, high: 53, low: 52.5, close: 52.9, time: 1642456676 },
    { open: 52.9, high: 53.5, low: 52.8, close: 53.2, time: 1642460276 },
    { open: 53.2, high: 53.8, low: 53, close: 53.6, time: 1642463876 },
    { open: 53.6, high: 54, low: 53.4, close: 53.9, time: 1642467476 },
    { open: 53.9, high: 54.3, low: 53.7, close: 54.1, time: 1642471076 },
    { open: 54.1, high: 54.6, low: 54, close: 54.4, time: 1642474676 },
    { open: 54.4, high: 54.9, low: 54.3, close: 54.7, time: 1642478276 },
    { open: 54.7, high: 55.1, low: 54.5, close: 54.9, time: 1642481876 },
    { open: 54.9, high: 55.3, low: 54.8, close: 55.1, time: 1642485476 },
    { open: 55.1, high: 55.6, low: 55, close: 55.3, time: 1642489076 },
    { open: 55.3, high: 55.8, low: 55.2, close: 55.6, time: 1642492676 },
    { open: 55.6, high: 56, low: 55.4, close: 55.9, time: 1642496276 }
  ],
  "1M": [
...
export default function CandlestickChart({ticker, fullScreen, selectedInterval}) {
  ...
  useEffect(() => {
    if (candlestickSeries && areaSeries) {
      ...
      candlestickSeries.setData(seriesesData[selectedInterval]); // Update candlestick data
      areaSeries.setData(
        seriesesData[selectedInterval].map((point) => ({
          time: point.time,
  ...
  return (
    <div className="w-full min-h-[490px] flex-grow flex flex-col items-start overflow-hidden">
