            ...
            <div className="w-full h-full flex-grow flex items-start">
              {/* side bar start */}
                <aside className={`transition-width flex-shrink-0 overflow-x-hidden py-4 pb-20 flex flex-col h-full border-r border-black/5 bg-primaryBg z-10 overflow-y-scroll scrollbar-thin max-md:absolute transition duration-300 ease-in-out ${sidebarHide? 'w-[4rem] max-md:w-max max-md:translate-x-[0]' : 'md:w-[16rem] max-md:w-max max-md:translate-x-[-900px]'}`}>
                    <div  onClick={() => updateUrl(undefined, 'chart')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'chart'? 'border-primaryMain' : 'border-white'}`}>
                    ...
                    <div onClick={() => updateUrl(undefined, 'gainers_losers')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'gainers_losers'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={() => updateUrl(undefined, 'news')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'news'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={() => updateUrl(undefined, 'technical_analysis')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'technical_analysis'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={() => updateUrl(undefined, 'earnings_calendar')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'earnings_calendar'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={() => updateUrl(undefined, 'insider_transactions')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'insider_transactions'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={() => updateUrl(undefined, 'historical')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'historical'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={() => updateUrl(undefined, 'watchlist')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'watchlist'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={() => updateUrl(undefined, 'trades')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'trades'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={() => updateUrl(undefined, 'level2')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'level2'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={() => updateUrl(undefined, 'stockverse_gpt')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'stockverse_gpt'? 'border-primaryMain' : 'border-white'}`}>
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="mt-auto flex flex-col">
                      <div onClick={() => updateUrl(undefined, 'settings')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'settings'? 'border-primaryMain' : 'border-white'}`}>
                        <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div onClick={() => updateUrl(undefined, 'help')} className={`w-max p-3 pl-4 border-l-4 cursor-pointer flex items-center gap-4 ${view === 'help'? 'border-primaryMain' : 'border-white'}`}>
                        <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
