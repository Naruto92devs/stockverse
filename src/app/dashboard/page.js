...
export default function DashBoard() {
    ...
    return (
        <section className="w-full flex flex-col h-[100dvh] overflow-hidden relative scrollbar-hide">
            {/* Nav bar start */}
            <nav className="flex-shrink-0 w-full flex items-center justify-between bg-primaryBg p-3 border-b border-black/5">
              <div className={`flex-shrink-0 relative flex items-center justify-between ${sidebarHide? 'md:w-[3rem] w-max' : 'md:w-[15rem] w-max'}`}>
                ...
                <Image className={`cursor-pointer transition-transform duration-300 ${sidebarHide ? 'rotate-180 absolute left-full z-10' : 'rotate-0'}`} onClick={toggleSidebar} src="/images/sidebar_toggle.png" width={36} height={36} alt='Stockverse Logo' />
              </div>
              <ProfileLogo/>
            </nav>
            {/* Nav bar end */}
            <div className="w-full h-full flex-grow flex items-start">
              {/* side bar start */}
                <div className={`flex-shrink-0 py-4 pb-20 flex flex-col h-full border-r border-black/5 bg-primaryBg z-10 overflow-y-scroll scrollbar-thin ${sidebarHide? 'w-[4rem] items-center ' : 'w-[16rem]'}`}>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Chart</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Top Gainers & Losers</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>News</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Technical Analysis</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Earnings Calendar</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Insider Transactions</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Historical</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Watch List</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Trades</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" clipRule="evenodd" d="M13.5 6.75C13.9142 6.75 14.25 7.08579 14.25 7.5V15C14.25 15.4142 13.9142 15.75 13.5 15.75C13.0858 15.75 12.75 15.4142 12.75 15V7.5C12.75 7.08579 13.0858 6.75 13.5 6.75Z" fill="black"/>
                      ...
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Level 2</p>
                    </div>
                    <div className="p-3 cursor-pointer flex items-center gap-2">
                      <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.75014 1.5L3.07023 9.51589C2.80863 9.82982 2.67782 9.98678 2.67582 10.1193C2.67409 10.2346 2.72544 10.3442 2.81508 10.4167C2.9182 10.5 3.12252 10.5 3.53117 10.5H9.00014L8.25014 16.5L14.93 8.48411C15.1917 8.17018 15.3225 8.01322 15.3245 7.88065C15.3262 7.76541 15.2748 7.65577 15.1852 7.58333C15.0821 7.5 14.8778 7.5 14.4691 7.5H9.00014L9.75014 1.5Z" stroke="black" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Stockverse Gpt</p>
                    </div>
                    ...
                    <div className="mt-auto flex flex-col">
                      <div className="p-3 cursor-pointer flex items-center gap-2">
                        ...
                        <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Settings</p>
                      </div>
                      <div className="p-3 cursor-pointer flex items-center gap-2">
                        <svg className="w-6 h-6" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className={`font-sansMedium text-primaryTextColor text-md ${sidebarHide? 'hidden' : 'visible'}`}>Help Center</p>
                      </div>
                      <div className={`w-full px-3 pt-4 ${sidebarHide? 'hidden' : 'visible'}`}>
