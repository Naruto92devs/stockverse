  ...
  return (
    <div className="hero py-16 max-md:py-6 w-full">
      <div className="px-6 max-sm:px-3 mx-auto xl:container gap-y-4 max-sm:gap-y-3 flex flex-col items-start">
        <h2 className="text-3xl font-sansSemibold text-primaryText">Disclaimer</h2>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Purpose</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Compensation Disclosure</h3>
        ...
        <h2 className="text-3xl font-sansSemibold text-primaryText mt-16">Stockverse Legal Disclaimer</h2>

        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Earnings & Performance Disclaimer</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">No Guarantee of Future Performance</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Investment Risks</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">No Financial Advice</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">AI & Data Disclaimer</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">AI Limitations & Potential Errors</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Delayed & Inaccurate Data</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">User Responsibility</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Limitation of Liability</h3>
        <p className="text-base text-primaryText">By using Stockverse, you acknowledge and agree that:</p>

        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">No Liability for Financial Losses</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">No Warranties</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Third-Party Data & External Links</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Use at Your Own Risk</h3>
        ...
        <h2 className="text-3xl font-sansSemibold text-primaryText mt-16">Governing Law & Dispute Resolution</h2>

        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Jurisdiction & Applicable Law</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Binding Arbitration</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Waiver of Class Action & Jury Trial</h3>
        ...
        <h2 className="text-3xl font-sansSemibold text-primaryText mt-16">Intellectual Property Rights</h2>

        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Ownership of Content</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Restrictions on Use</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">AI-Generated Content & Licensing</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">DMCA & Copyright Violations</h3>
        ...
        <h3 className="mt-8 text-primaryText text-xl font-sansSemibold">Acceptance of Terms</h3>
