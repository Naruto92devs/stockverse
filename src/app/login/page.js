...
export default function LogIn() {
  ...
  return (
    <div className={`${VerifyOTP ? 'bg-loginBg bg-cover bg-center bg-no-repeat' : ''} w-full lg:flex max-lg:flex-col xl:min-h-[100vh]`}>
      ...
      <div className={` ${VerifyOTP ? 'hidden' : 'flex'} lg:w-[50%] 2xl:px-40 lg:px-6 md:px-32 sm:px-6 max-lg:py-20 max-sm:px-3 gap-y-2 max-sm:gap-y-3 flex flex-col items-center justify-center`}>
          ...
          <div className="p-8 max-sm:px-4 rounded-xl flex flex-col gap-y-8 items-center bg-white shadow-lg">
            ...
            <div className="w-full flex flex-col gap-y-2">
              ...
              <input
                ...
                required
                className="w-full text-base font-sansRegular px-4 py-2 border bg-mobNavLink text-primaryTextColor border-primaryTextColor/40 rounded-lg focus:outline-none focus:border-primaryTextColor"
              />
            </div>
            <button
              disabled={loading}
