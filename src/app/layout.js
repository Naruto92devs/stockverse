...
export default function RootLayout({ children }) {
  ...
  const excludedNavbarRoutes = ['/stockverse-gpt', '/gpt', '/dashboard', '/login', '/register', '/', '/homepage', '/alerts', '/cadrenal', '/cvkd', '/newsletter', '/alert'];
  // Define routes where Footer should be hidden
  const excludedFooterRoutes = ['/stockverse-gpt', '/gpt', '/dashboard', '/login', '/register', '/', '/neovolta', '/cadrenal-page', '/stockversegpt-overview', '/help-center', '/homepage', '/alerts', '/return', '/cadrenal', '/reset_password', '/newsletter', '/alert'];
