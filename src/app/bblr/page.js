      ...
      <section className="bg-[#010e140d] 2xl:py-20 xl:py-24 py-12 ">
        <div className="w-full xl:container mx-auto px-3 flex justify-between max-lg:flex-col max-lg:gap-y-8">
          <div className="w-[64%] max-lg:w-[100%] flex flex-col">
            <h1 className="text-[#1D3045] 2xl:text-6xl sm:text-5xl text-[2rem] !leading-[1.2] font-syneBold">Brand New Stock Pick: </h1>
            <h2 className="text-[#12A72E] 2xl:text-6xl sm:text-5xl text-[2rem] !leading-[1.2] font-syneBold pl-0 max-md:pl-0">BBLR (OTCQB)</h2>
