      ...
      <section>
        <div className="hero py-16 max-md:py-6 w-full border-t-[1.2px] mt-20 border-[#404040]">
                <div className="mx-auto xl:container gap-y-4 max-sm:gap-y-3 px-8 xl:px-3 flex flex-col items-start">
                  ...
                  <p className="text-lg font-inter text-primaryText">
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">IMPORTANT SUMMARY — PLEASE READ FIRST</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">1. NATURE AND INTENT OF THIS COMMUNICATION</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">2. COMPENSATION FOR BUBBLR INC. (BBLR)</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">3. INTENDED AUDIENCE</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">4. NO ENDORSEMENT OR VERIFICATION OF COMPANY CLAIMS</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">5. MARKET INFLUENCE AND TRADING PATTERN EXPECTATION</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">6. NO RELIANCE – INVESTOR RESPONSIBILITY</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">7. FORWARD-LOOKING STATEMENTS AND SAFE HARBOR</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-font-inter font-bold">8. INFORMATION SOURCING, BIAS, AND ACCURACY</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">9. OWNERSHIP AND TRADING CONFLICTS</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">10. MARKETING TOOLS, DATA COLLECTION, AND USER CONSENT</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">11. ADVERTISING LAW COMPLIANCE</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">12. NON-U.S. USERS</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">13. DISCLAIMER OF WARRANTIES AND LIMITATION OF LIABILITY</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">14. LEGAL GOVERNANCE AND DISPUTE RESOLUTION</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">15. NON-SOLICITATION AND GEOGRAPHIC LIMITATIONS</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">16. FINAL NOTICE – ACCEPTANCE OF TERMS</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-inter font-bold">17. NO RELIANCE</h4>
