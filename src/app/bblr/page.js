      ...
      <section>
        <div className="hero py-16 max-md:py-6 w-full border-t-[1.2px] mt-20 border-[#404040]">
                <div className="mx-auto xl:container gap-y-4 max-sm:gap-y-3 px-8 xl:px-3 flex flex-col items-start">
                  ...
                  <p className="text-base text-primaryText font-inter">Relqo Media LLC has been retained by Genesis One Holdings LLC to provide promotional media services for Bubblr Inc. (OTCQB: BBLR). As of the effective date 5/30 2025 to June 8th 2025:</p>
