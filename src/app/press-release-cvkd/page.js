    ...
    return (
        <div className="w-full h-full mx-auto xl:container lg:px-[15%] max-xl:px-3">
            ...
            <div className="py-12 gap-y-6 flex max-lg:flex-col-reverse max-lg:items-start items-center justify-between">
                <h1 className="text-4xl font-serif max-sm:text-2xl  text-left text-primaryText/70 lg:w-[70%] leading-[140%]">CADRENAL THERAPEUTICS HIGHLIGHTS PRESENTATION AT EUROPEAN ASSOCIATION FOR CARDIO-THORACIC SURGERY (EACTS) MEDICAL CONGRESS</h1>
            ...
            <div className="py-8 border-y-[1px] border-primaryText/20 max-sm:px-3  gap-y-6 flex flex-wrap items-center justify-between">
                <div className="flex flex-col">
                    ...
                    <p className="text-sm  text-primaryText leading-[110%]">Nov 12, 2024, 09:00 ET</p>
                </div>
                <div className="">
            ...
            <div className="flex flex-col gap-8 py-4">
                ...
                <p className="text-base  text-primaryText leading-[200%]">{`For more information, please contact:`}</p>
