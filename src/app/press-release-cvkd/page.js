...
const PRESSRELEASECVKD = () => {
    ...
    return (
        <div className="w-full h-full mx-auto xl:container lg:px-[10%] max-xl:px-3">
            ...
            <div className="py-12 gap-y-6 flex max-lg:flex-col-reverse max-lg:items-start items-center justify-between">
                <h1 className="text-4xl max-sm:text-2xl font-sansMedium text-left text-primaryText lg:w-[70%] leading-[140%]">CADRENAL THERAPEUTICS HIGHLIGHTS PRESENTATION AT EUROPEAN ASSOCIATION FOR CARDIO-THORACIC SURGERY (EACTS) MEDICAL CONGRESS</h1>
            ...
            <div className="py-8 border-y-[1px] border-primaryText/20 max-sm:px-3  gap-y-6 flex flex-wrap items-center justify-between">
                <div className="flex flex-col">
                    <p className="text-lg font-sansSemibold text-primaryText leading-[110%]">News Provided by</p>
                    <Link href='https://stockverse.com/news' className=" leading-[110%] text-md font-sansMedium text-primaryHeading">Stockverse.com</Link>
                    <p className="text-sm font-sansRegular text-primaryText leading-[110%]">Nov 12, 2024, 09:00 ET</p>
                </div>
                <div className="">
                    <p className="text-base font-sansMedium text-primaryText leading-[110%]">SHARE THIS ARTICLE</p>
