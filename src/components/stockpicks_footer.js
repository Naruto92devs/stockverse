...
const Footer = ()=>{
    return(
        <footer className="bg-[#000] rounded-tl-3xl rounded-tr-3xl py-8">
            <div className="w-full xl:container mx-auto">
                <div className="flex items-center gap-[25%] mb-4">
                ...
                <h2 className="text-[#fff] text-2xl">Disclaimer  &#160;&#160;   |   &#160;&#160;  Privacy</h2>
                </div>
                <p className="text-[#A5A4A1] text-center text-[0.9rem] border-b border-[#fff] pb-8">
                    ...
                    <p className="text-[#fff] font-poppinsRegular text-base text-center pt-8">©2018 beatpennystocks.com    &#160;&#160;  |  &#160;&#160;   ALL RIGHTS RESERVED</p>
            </div>
        </footer>
    )
}
