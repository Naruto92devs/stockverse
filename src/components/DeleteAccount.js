...
export default function DeleteAccount() {
    ...
    return (
        <form onSubmit={handleDeleteAccount} className="w-full flex flex-col items-start space-y-4">
            <div className='flex flex-col gap-2'>
                <h1 className='text-lg font-sansMedium text-prmiaryTextColor'>Delete my account</h1>
                <p className='text-base font-sansRegular text-prmiaryTextColor'>Deleting your account will remove all of your information from our database. This cannot be undone.</p>
            </div>
            <div className="w-full flex flex-col gap-2 relative">
                <p className='text-base font-sansRegular'>To confirm, Enter Your Password!</p>
                ...
                <button
                    ...
                    className="absolute right-3 top-[4.3rem] text-3xl text-secondaryHeading focus:outline-none"
                >
                    {passwordVisible ? 
            ...
            <div className="flex gap-4">
                <button
                    disabled={delLoading}
                    type="submit"
                    className="px-4 bg-sell text-base text-white py-2 hover:bg-black rounded-xl transition duration-300"
                >
