                            ...
                            {results.map((result) => (
                                ...
                                >
                                    ...
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <div className='flex items-center gap-1 sm:text-base text-sm font-sansMedium bg-primaryMain/10 border border-primaryMain/5 px-2 pr-3 py-[2px] rounded-full'>
