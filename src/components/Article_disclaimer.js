...
export default function Disclaimer(){
    return(
                ...
                <div className="mx-auto xl:container gap-y-4 max-sm:gap-y-3 flex flex-col items-start">
                  <h4 className="text-3xl font-sansSemibold text-primaryText">Disclaimer</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Purpose</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Compensation Disclosure</h4>
                  ...
                  <h4 className="text-3xl font-sansSemibold text-primaryText mt-16">Stockverse Legal Disclaimer</h4>

                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Earnings & Performance Disclaimer</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">No Guarantee of Future Performance</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Investment Risks</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">No Financial Advice</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">AI & Data Disclaimer</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">AI Limitations & Potential Errors</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Delayed & Inaccurate Data</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">User Responsibility</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Limitation of Liability</h4>
                  <p className="text-base text-primaryText">By using Stockverse, you acknowledge and agree that:</p>

                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">No Liability for Financial Losses</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">No Warranties</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Third-Party Data & External Links</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Use at Your Own Risk</h4>
                  ...
                  <h4 className="text-3xl font-sansSemibold text-primaryText mt-16">Governing Law & Dispute Resolution</h4>

                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Jurisdiction & Applicable Law</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Binding Arbitration</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Waiver of Class Action & Jury Trial</h4>
                  ...
                  <h4 className="text-3xl font-sansSemibold text-primaryText mt-16">Intellectual Property Rights</h4>

                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Ownership of Content</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Restrictions on Use</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">AI-Generated Content & Licensing</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">DMCA & Copyright Violations</h4>
                  ...
                  <h4 className="mt-8 text-primaryText text-xl font-sansSemibold">Acceptance of Terms</h4>
