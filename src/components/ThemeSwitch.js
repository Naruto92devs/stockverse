...
export default function ThemeSwitch() {
  ...
  if (!mounted) return (
    <div className="w-[42px] h-[42px] max-lg:hidden">
      <Image 
        className="opacity-0"
  ...
  return (
    <div onClick={handleClick} className={`z-10 transform transition-transform duration-400 max-lg:fixed max-lg:bottom-[12%] max-lg:right-3 ${isRotated ? 'rotate-45' : ''}`}>
      {resolvedTheme === 'dark' ? (
        <svg className="max-lg:bg-mobNavBg max-lg:shadow-xl cursor-pointer w-[42px] h-[42px] rounded-full p-2 lg:hover:bg-primaryText/10 max-lg:hover-bg:none"
