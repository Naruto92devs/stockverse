...
<div onClick={handleClick} className={`transform transition-transform duration-400 ${isRotated ? 'rotate-45' : ''}`}>
    {resolvedTheme === 'dark' ? (
    <svg className="cursor-pointer w-[42px] h-[42px] rounded-full p-2 hover:bg-primaryText/10"
    ...
    <svg className="-rotate-45 cursor-pointer w-[42px] h-[42px] rounded-full p-2 hover:bg-primaryText/10"
