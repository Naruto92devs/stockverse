    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await fetch(`${STOCKVERSE_BACK_END}/loser-stocks`);
            ...
            {(loading || !stockData || stockData.length === 0) ? (
                ...
                stockData.map((stock) => (
                    <div key={stock.symbol} className="w-full items-center flex justify-between py-2 px-3 max-sm:px-1.5">
                        ...
                        <rect width="44" height="44" transform="translate(0 0.5)" fill="#EB001B"/>
                        <path d="M31 27.5L23 19.5L19 23.5L13 17.5M23 27.5H31H23ZM31 27.5V19.5V27.5Z" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
