...
export default function LogInPopup() {
  ...
  return (
    <div className={`${isLogin ? 'visible' : 'hidden'} fixed z-50 top-0 left-0 bottom-0 right-0 p-4 w-full flex bg-black/10 backdrop-blur-sm flex flex-col items-center justify-center h-full max-h-screen overflow-y-scroll scrollbar-hide`}>
      <div className={`md:w-[700px] w-full min-h-max flex sm:flex-row flex-col items-center bg-primaryBg rounded-xl overflow-hidden`}>
